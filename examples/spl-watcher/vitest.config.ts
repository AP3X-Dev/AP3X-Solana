...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@ap3x/solana-spl': path.resolve(__dirname, '../../packages/solana-spl/src/index.ts'),
      ...
      '@ap3x/solana-executor': path.resolve(__dirname, '../../packages/solana-executor/src/index.ts'),
      '@ap3x/solana-portfolio': path.resolve(__dirname, '../../packages/solana-portfolio/src/index.ts'),
      '@ap3x/solana-vault': path.resolve(__dirname, '../../packages/solana-vault/src/index.ts'),
    },
  },
  test: {
