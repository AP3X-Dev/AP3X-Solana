...
| **02.5** | [Pump.fun protocol](./02.5-pumpfun-protocol.md) | 1-2 | `@ap3x/pumpfun-protocol` + `@ap3x/pumpfun-events` — first Solana vertical: pump.fun program decoders, bonding curve math, typed read-only on-chain client. Off-chain APIs (advanced-api-v2 / frontend-api-v3) re-homed to PRP-04 as a signal source. Read-only; validates the substrate + runtime abstractions. |
